...
import React, { useReducer, useCallback, useContext, createContext, memo, useMemo, useEffect } from 'react';
...
var WrappedModalComponent$1 = /*#__PURE__*/memo(WrappedModalComponent, isEqual);
...
function useModal(params) {
  ...
  return [React.createElement(WrappedModalComponent$1, {
    render: render,
    modalProps: props,
    opened: opened,
...
function withModals(Component) {
  return function (modals) {
    return function (props) {
      ...
      var loadModals = useCallback(function () {
...
export { ModalProvider, useModal, withModals };
