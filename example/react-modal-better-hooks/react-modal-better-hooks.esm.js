...
import React, { useReducer, useCallback, useContext, createContext, useState, useRef, useMemo, useEffect, createElement } from 'react';
...
(function (ModalActionType) {
  ...
  ModalActionType["AddLazyModal"] = "AddLazyModal";
...
function useModal(params) {
  ...
  var open = useCallback( /*#__PURE__*/function () {
  ...
  var update = useCallback(function (_ref2) {
  ...
  var close = useCallback(function (modalId) {
...
function withModals(Component) {
  return function (modals) {
    return function (props) {
      ...
      var loadModal = useCallback( /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(id) {
          var modal, module;
      ...
      var addModalsToState = useCallback(function () {
...
export { ModalProvider, useCloseModal, useModal, withModals };
